...
const config = {
  ...
  projects: [
    ...
    {
      name: "vrt:chromium",
      testIgnore: ["a11y.*.spec.js", "*.spec.e2e.js", "*.spec.mobile-e2e.js"],
      use: {
    ...
    {
      name: "e2e:chromium",
      testIgnore: ["a11y.*.spec.js", "*.spec.vrt.js", "*.spec.mobile-e2e.js"],
      use: {
        ...devices["Desktop Chrome"],
      },
    },
    ...
    /* End-to-end tests against mobile viewports. */
    {
      ...
      testIgnore: ["a11y.*.spec.js", "*.spec.vrt.js", "*.spec.e2e.js"],
      use: {
        ...devices["Pixel 5"],
      },
    },
